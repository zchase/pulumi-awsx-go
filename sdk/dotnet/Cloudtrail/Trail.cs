...
namespace Pulumi.AwsxGo.Cloudtrail
{
    [AwsxGoResourceType("awsx-go:cloudtrail:Trail")]
    public partial class Trail : Pulumi.ComponentResource
    {
        ...
        public Trail(string name, TrailArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:cloudtrail:Trail", name, args ?? new TrailArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class TrailArgs : Pulumi.ResourceArgs
    {
        ...
        public Pulumi.AwsxGo.AwsxGo.Inputs.OptionalLogGroupArgs? CloudWatchLogsGroup { get; set; }
        ...
        /// </summary>
        [Input("s3Bucket")]
        public Pulumi.AwsxGo.AwsxGo.Inputs.RequiredBucketArgs? S3Bucket { get; set; }
