...
namespace Pulumi.AwsxGo.Lb
{
    ...
    /// </summary>
    [AwsxGoResourceType("awsx-go:lb:NetworkLoadBalancer")]
    public partial class NetworkLoadBalancer : Pulumi.ComponentResource
    {
        ...
        public NetworkLoadBalancer(string name, NetworkLoadBalancerArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:lb:NetworkLoadBalancer", name, args ?? new NetworkLoadBalancerArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
