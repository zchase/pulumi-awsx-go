...
namespace Pulumi.AwsxGo.Lb
{
    ...
    /// </summary>
    [AwsxGoResourceType("awsx-go:lb:TargetGroupAttachment")]
    public partial class TargetGroupAttachment : Pulumi.ComponentResource
    {
        ...
        public TargetGroupAttachment(string name, TargetGroupAttachmentArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:lb:TargetGroupAttachment", name, args ?? new TargetGroupAttachmentArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
