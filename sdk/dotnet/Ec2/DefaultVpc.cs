...
namespace Pulumi.AwsxGo.Ec2
{
    ...
    /// </summary>
    [AwsxGoResourceType("awsx-go:ec2:DefaultVpc")]
    public partial class DefaultVpc : Pulumi.ComponentResource
    {
        ...
        public DefaultVpc(string name, DefaultVpcArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:ec2:DefaultVpc", name, args ?? new DefaultVpcArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
