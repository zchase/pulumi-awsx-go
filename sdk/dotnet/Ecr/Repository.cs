...
namespace Pulumi.AwsxGo.Ecr
{
    ...
    /// </summary>
    [AwsxGoResourceType("awsx-go:ecr:Repository")]
    public partial class Repository : Pulumi.ComponentResource
    {
        ...
        public Repository(string name, RepositoryArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:ecr:Repository", name, args ?? new RepositoryArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
