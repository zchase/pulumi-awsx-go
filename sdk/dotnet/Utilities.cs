...
namespace Pulumi.AwsxGo
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AwsxGo.version.txt");
    ...
    internal sealed class AwsxGoResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsxGoResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
