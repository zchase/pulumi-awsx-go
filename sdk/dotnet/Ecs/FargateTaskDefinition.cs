...
namespace Pulumi.AwsxGo.Ecs
{
    ...
    /// </summary>
    [AwsxGoResourceType("awsx-go:ecs:FargateTaskDefinition")]
    public partial class FargateTaskDefinition : Pulumi.ComponentResource
    {
        ...
        public FargateTaskDefinition(string name, FargateTaskDefinitionArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx-go:ecs:FargateTaskDefinition", name, args ?? new FargateTaskDefinitionArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class FargateTaskDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("executionRole")]
        public Pulumi.AwsxGo.Inputs.DefaultRoleWithPolicyArgs? ExecutionRole { get; set; }
        ...
        /// </summary>
        [Input("logGroup")]
        public Pulumi.AwsxGo.Inputs.DefaultLogGroupArgs? LogGroup { get; set; }
        ...
        /// </summary>
        [Input("taskRole")]
        public Pulumi.AwsxGo.Inputs.DefaultRoleWithPolicyArgs? TaskRole { get; set; }
