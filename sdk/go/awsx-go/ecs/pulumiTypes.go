...
import (
	...
	"github.com/pulumi/pulumi-awsx-go/sdk/go/awsx-go/awsxgo"
...
type EC2ServiceTaskDefinition struct {
	...
	ExecutionRole *awsxgo.DefaultRoleWithPolicy `pulumi:"executionRole"`
	...
	LogGroup *awsxgo.DefaultLogGroup `pulumi:"logGroup"`
	...
	// Will be created automatically if not defined.
	TaskRole *awsxgo.DefaultRoleWithPolicy `pulumi:"taskRole"`
...
type EC2ServiceTaskDefinitionArgs struct {
	...
	// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
	// Will be created automatically if not defined.
	ExecutionRole *awsxgo.DefaultRoleWithPolicyArgs `pulumi:"executionRole"`
	// An optional unique name for your task definition. If not specified, then a default will be created.
	...
	// A set of volume blocks that containers in your task may use.
	LogGroup *awsxgo.DefaultLogGroupArgs `pulumi:"logGroup"`
	// The amount (in MiB) of memory used by the task.  If not provided, a default will be computed
	// based on the cumulative needs specified by [containerDefinitions]
	...
	// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
	// Will be created automatically if not defined.
	TaskRole *awsxgo.DefaultRoleWithPolicyArgs `pulumi:"taskRole"`
	// Configuration block for volumes that containers in your task may use. Detailed below.
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o EC2ServiceTaskDefinitionOutput) ExecutionRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v EC2ServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy { return v.ExecutionRole }).(awsxgo.DefaultRoleWithPolicyPtrOutput)
}
...
// A set of volume blocks that containers in your task may use.
func (o EC2ServiceTaskDefinitionOutput) LogGroup() awsxgo.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v EC2ServiceTaskDefinition) *awsxgo.DefaultLogGroup { return v.LogGroup }).(awsxgo.DefaultLogGroupPtrOutput)
}
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o EC2ServiceTaskDefinitionOutput) TaskRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v EC2ServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy { return v.TaskRole }).(awsxgo.DefaultRoleWithPolicyPtrOutput)
}
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o EC2ServiceTaskDefinitionPtrOutput) ExecutionRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *EC2ServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
		return v.ExecutionRole
	}).(awsxgo.DefaultRoleWithPolicyPtrOutput)
}
...
// A set of volume blocks that containers in your task may use.
func (o EC2ServiceTaskDefinitionPtrOutput) LogGroup() awsxgo.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v *EC2ServiceTaskDefinition) *awsxgo.DefaultLogGroup {
		if v == nil {
			return nil
		}
		return v.LogGroup
	}).(awsxgo.DefaultLogGroupPtrOutput)
}
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o EC2ServiceTaskDefinitionPtrOutput) TaskRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *EC2ServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionOutput) ExecutionRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy { return v.ExecutionRole }).(awsxgo.DefaultRoleWithPolicyPtrOutput)
}
...
// A set of volume blocks that containers in your task may use.
func (o FargateServiceTaskDefinitionOutput) LogGroup() awsxgo.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *awsxgo.DefaultLogGroup { return v.LogGroup }).(awsxgo.DefaultLogGroupPtrOutput)
}
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionOutput) TaskRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy { return v.TaskRole }).(awsxgo.DefaultRoleWithPolicyPtrOutput)
}
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionPtrOutput) ExecutionRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
		return v.ExecutionRole
...
// A set of volume blocks that containers in your task may use.
func (o FargateServiceTaskDefinitionPtrOutput) LogGroup() awsxgo.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *awsxgo.DefaultLogGroup {
		if v == nil {
			return nil
		}
		return v.LogGroup
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionPtrOutput) TaskRole() awsxgo.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *awsxgo.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
